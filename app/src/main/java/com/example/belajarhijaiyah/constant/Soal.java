package com.example.belajarhijaiyah.constant;

public class Soal {

    // ─── HIJAIYAH ────────────────────────────────────────────────────────────
    public static final String[][] hijaiyah = {
            {"kuis_alif",  "ا", "ج", "د", "ح"}, //1
            {"kuis_ba", "ب","ذ", "ش", "ت"},      //2
            {"kuis_ta", "ت", "خ", "ظ", "ب"},     //3
            {"kuis_tsa", "ث", "ب", "ر", "ك"},    //4
    ...
    // ─── FATHAH ──────────────────────────────────────────────────────────────
    public static final String[][] fathah = {
            {"kuisfathah_a",   "اَ", "كَ", "د",  "ضَ"},
            {"kuisfathah_ba",  "بَ", "ح",  "فَ", "جَ"},
            {"kuisfathah_ta",  "تَ", "بَ", "نَ", "هَ"},
    ...
    // ─── KASROH ──────────────────────────────────────────────────────────────
    public static final String[][] kasroh = {
    ...
    // ─── DHOMMAH ─────────────────────────────────────────────────────────────
    public static final String[][] dhommah = {
    ...
    // ─── FATAIN (Tanwin Fathah) ───────────────────────────────────────────────
    public static final String[][] fatainData = {
    ...
    // ─── KASTAIN (Tanwin Kasroh) ──────────────────────────────────────────────
    public static final String[][] kastain = {
    ...
    // ─── DOTAIN (Tanwin Dhommah) ──────────────────────────────────────────────
    public static final String[][] dotain = {
